...
class FieldDef
{
	...
	public function hasConstructorDefault() : bool
	{
		return $this->constructor_default !== null;
	}

	public function getConstructorDefault() : ?DefaultDef
	{
		return $this->constructor_default;
	}

	public function getSerializedDefault() : ?DefaultDef
	{
		return $this->serialized_default;
	}
	...
	public function makeEqualsFragment($peer_l_value, $indent) : string
	{
		$property_name = $this->name;
	...
	public function makeUses(string $namespace) : iterable
	{
		yield from $this->type->getUses($namespace);
	}
