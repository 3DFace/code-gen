...
return [
	...
	'SomeClass' => [
		...
		'field2json' => ['type' => new JsonType(new DynamicTypeDef(new ClassName(SomeSibling::class), true), 0 ,0, false)],
		'field3' => ['type' => Value::class, 'empty' => 'none', 'silent' => true, 'null' => true],
